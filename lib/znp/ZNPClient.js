...
ZNPClient.prototype.startCoordinator = function() {
  ...
  var startRequest = when_sequence([
    ...
    this.writeConfiguration.bind(this, 'ZCD_NV_PANID', 2, 0xFFFF),
...
ZNPClient.prototype._registerForCallbacks = function() {
  ...
  return this.comms
    ...
    .then(function(status) {
      ...
      debug('_registerForCallbacks', 'response status', status);
...
var SRC_ENDPOINT = 0x01; // FIXME: this is hardcoded, but shouldn't be. BUT iinet's sensors want to go here by default.
/**
